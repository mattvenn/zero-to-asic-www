...
description: A semiconductor foundry (or fab) is a factory that manufactures chips designed by other companies; examples include SkyWater, TSMC, and Global Foundries.
faq:
  - q: What is a semiconductor foundry?
    a: A foundry is the semiconductor industry term for a factory that manufactures chips. When a fab produces ASICs for other companies (not its own designs), it is typically called a foundry. Examples include SkyWater, TSMC, and Global Foundries.
  - q: What is the history of the SkyWater foundry?
