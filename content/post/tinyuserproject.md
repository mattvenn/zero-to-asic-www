...
The actions automatically perform the steps requried to harden the design, generate the necessary [GDS](/terminology/gds/) files, and even generate a convenient GDS viewer.
