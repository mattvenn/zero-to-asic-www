...
You can get all the details on all the projects submitted to MPW2 [here](https://platform.efabless.com/projects/public) - you'll need to select the MPW2 filter.
